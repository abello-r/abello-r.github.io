...
//	if (e !== undefined) e.preventDefault()
	...
	fetch(`/${user1}/${user2}`, {})
		...
		.then(async (datos) =>
		{
			...
			document.getElementById("showPower").innerHTML = "Power : " + datos[0].power
			power = datos[0].power
			...
			document.getElementById("showPower_two").innerHTML = "Power : " + datos[1].power
...
const ft_victory = (e) =>
{
	if (power > 0 && power_two > 0)
	{
		if (power > power_two) // If player ONE wins.
		{
			...
			document.getElementById("victory").innerHTML = "¡" + player_one + " wins!" + "<br>" + "Streak's = " + streak_one // Set streaks p1
		}
...
function ft_win_phrases()
{
	...
	if (pick.selectedOptions[0].value == "Marvin") // Marvin phrases
	{
	...
	else if (pick.selectedOptions[0].value == "Hulk") // Hulk phrases
	{
	...
	else if (pick.selectedOptions[0].value == "Pickle") // Pickle phrases
	{
	...
	else if (pick.selectedOptions[0].value == "Spider-Man") // Spiderman phrases
	{
		document.getElementById("msg_winner").style.color = "#f70050"
		if (ran == 1)
			document.getElementById("msg_winner").innerHTML = "J.J. doesn't pay me enough for this!"
		else if (ran == 2)
			document.getElementById("msg_winner").innerHTML = "Great fight; and some great pics for J.J.!"
		else if (ran == 3)
			document.getElementById("msg_winner").innerHTML = "With great power comes great responsibility"
	}
	else if (pick.selectedOptions[0].value == "Batman") // Batman phrases
	{
		document.getElementById("msg_winner").style.color = "black"
		if (ran == 1)
			document.getElementById("msg_winner").innerHTML = "I’m Batman."
		else if (ran == 2)
			document.getElementById("msg_winner").innerHTML = "The world only makes sense if you force it to."
		else if (ran == 3)
			document.getElementById("msg_winner").innerHTML = "It’s not who I am underneath, but what I do that defines me."
	}
	else if (pick.selectedOptions[0].value == "Iron-Man") // IronMan phrases
	{
		document.getElementById("msg_winner").style.color = "#cfa900"
		if (ran == 1)
			document.getElementById("msg_winner").innerHTML = "I am Iron Man."
		else if (ran == 2)
			document.getElementById("msg_winner").innerHTML = "Give me a scotch. I'm starving."
		else if (ran == 3)
			document.getElementById("msg_winner").innerHTML = "I love you 3000."
	}
	else if (pick.selectedOptions[0].value == "Deadpool") // Deadpool phrases
	{
		document.getElementById("msg_winner").style.color = "#b60200"
		if (ran == 1)
			document.getElementById("msg_winner").innerHTML = "House blowing up builds character."
		else if (ran == 2)
			document.getElementById("msg_winner").innerHTML = "Bad Deadpool... Good Deadpool!"
		else if (ran == 3)
			document.getElementById("msg_winner").innerHTML = "Whose kitty litter did I just shit in?"
	}
	else if (pick.selectedOptions[0].value == "Superman") // Superman phrases
	{
		document.getElementById("msg_winner").style.color = "blue"
		if (ran == 1)
			document.getElementById("msg_winner").innerHTML = "Dreams save us."
		else if (ran == 2)
			document.getElementById("msg_winner").innerHTML = "I’m here to fight for truth and justice."
		else if (ran == 3)
			document.getElementById("msg_winner").innerHTML = "You’re stronger than you think you are. trust me."
	}
	else if (pick.selectedOptions[0].value == "Wolverine") // Wolverine phrases
	{
		document.getElementById("msg_winner").style.color = "#e3be00"
		if (ran == 1)
			document.getElementById("msg_winner").innerHTML = "Patience isn't my strongest suit."
		else if (ran == 2)
			document.getElementById("msg_winner").innerHTML = "Nature made me a freak. Man made me a weapon. And God made it last too long."
		else if (ran == 3)
			document.getElementById("msg_winner").innerHTML = "The pain lets you know you’re still alive."
	}
	else if (pick.selectedOptions[0].value == "Trump") // Donald Trump phrases
	{
		document.getElementById("msg_winner").style.color = "#00aae4"
		if (ran == 1)
			document.getElementById("msg_winner").innerHTML = "Everything in life is luck."
		else if (ran == 2)
			document.getElementById("msg_winner").innerHTML = "The elections were a fraud."
		else if (ran == 3)
			document.getElementById("msg_winner").innerHTML = "¡Save America!"
	}
	else if (pick.selectedOptions[0].value == "The-Bicho") // Cristiano Ronaldo phrases
	{
		document.getElementById("msg_winner").style.color = "red"
		if (ran == 1)
			document.getElementById("msg_winner").innerHTML = "Your love makes me strong, your hate makes me unstoppable."
		else if (ran == 2)
			document.getElementById("msg_winner").innerHTML = "¡Siuuuuuuuuuuu!"
		else if (ran == 3)
			document.getElementById("msg_winner").innerHTML = "Talent without working hard is nothing."
	}
	else if (pick.selectedOptions[0].value == "BugsBunny") // Bugsbunny phrases
	{
		document.getElementById("msg_winner").style.color = "orange"
		if (ran == 1)
			document.getElementById("msg_winner").innerHTML = "I’m just a little wabbit!"
		else if (ran == 2)
			document.getElementById("msg_winner").innerHTML = "What’s up, Doc?"
		else if (ran == 3)
			document.getElementById("msg_winner").innerHTML = "Ehhhhhh, shut up!"
	}
	else if (pick.selectedOptions[0].value == "Agnes-Gru") // Agnes Gru phrases
	{
		document.getElementById("msg_winner").style.color = "pink"
		if (ran == 1)
			document.getElementById("msg_winner").innerHTML = "It's so fluffy I'm gonna die."
		else if (ran == 2)
			document.getElementById("msg_winner").innerHTML = "Oh, my gosh look at that fluffy unicorn!"
		else if (ran == 3)
